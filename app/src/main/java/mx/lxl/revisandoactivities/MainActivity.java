    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Pasamos las variables en el intent a la siguiente actividad (Mostrar)
                Intent intent = new Intent(getBaseContext(), Mostrar.class);

                intent.putExtra("nombre", "Nombre: "+teNombre.getText().toString());
                intent.putExtra("fechaNacimiento", "Fecha nacimiento: "+ year+"-"+month+"-"+day);
                intent.putExtra("telefono", "Teléfono: "+ teTelefono.getText().toString());
                intent.putExtra("email", "Email: "+ teEmail.getText().toString());
                intent.putExtra("descripcionContacto", "Descripcion Contacto: "+ teDescripcionContacto.getText().toString());
